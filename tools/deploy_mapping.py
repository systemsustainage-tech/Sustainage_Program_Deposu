...
def deploy_changes():
    ...
    try:
        ...
        # 1. Deploy mapping_manager.py
        local_path = 'backend/modules/mapping/mapping_manager.py'
        remote_path = '/var/www/sustainage/backend/modules/mapping/mapping_manager.py'
        ...
        # 3. Deploy mapping.html
        local_path = 'templates/mapping.html'
        remote_path = '/var/www/sustainage/templates/mapping.html'
        print(f"Uploading {local_path} to {remote_path}...")
        sftp.put(local_path, remote_path)
