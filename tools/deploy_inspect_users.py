...
def upload_files():
    try:
        ...
        print("Running inspect script on remote server...")
        stdin, stdout, stderr = ssh.exec_command(f"python3 {REMOTE_BASE}/tools/inspect_remote_users.py")
