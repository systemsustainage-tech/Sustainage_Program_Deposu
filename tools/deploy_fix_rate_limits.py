...
FILES_TO_UPLOAD = [
    "tools/fix_rate_limits_table.py"
]
...
def upload_files():
    try:
        ...
        # Run the fix script
        print("Running fix script on remote server...")
        stdin, stdout, stderr = ssh.exec_command(f"python3 {REMOTE_BASE}/tools/fix_rate_limits_table.py")
