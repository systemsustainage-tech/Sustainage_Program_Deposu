...
# -*- coding: utf-8 -*-
"""
SUSTAINAGE SDG - Final Çalışan Email Şablonu
- Format hatası olmayan final şablon
"""
...
def get_logo_base64():
    ...
    logo_path = os.path.join(os.path.dirname(__file__), '..', 'resimler', 'mail.jpg')
...
# Final çalışan email şablonu
FINAL_WORKING_TEMPLATE = f"""
<!DOCTYPE html>
<html lang="tr">
<head>
    <meta charset="UTF-8">
