...
class CalculationGUI:
    ...
    def setup_ui(self):
        ...
        header.pack(fill='x')
        ttk.Label(header, text=self.lm.tr('adv_calc_title', "Gelismis Hesaplama"), style='Header.TLabel').pack(side='left', padx=12)
        ...
        ttk.Label(main_frame, text=self.lm.tr('adv_calc_header', "Gelismis Hesaplama"), font=('Segoe UI', 16, 'bold')).pack(pady=(0, 20))

        text = self.lm.tr('adv_calc_info', """
...
DURUM: Modul aktif
Hesaplama: Simdilik simulasyon modu
""")
    ...
    def refresh_view(self) -> None:
        try:
            # Placeholder for recalculations bound to period
