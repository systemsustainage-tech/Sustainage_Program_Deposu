...
--------------------------------------------------
Açıklama: Web programı için uyarlanmış veritabanı performans testi.
Hedef Dosya: tests/test_database_performance.py
--------------------------------------------------
"""
import sys
import os
...
target_test = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'tests', 'test_database_performance.py'))
