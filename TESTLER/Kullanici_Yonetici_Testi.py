...
--------------------------------------------------
Açıklama: Web programı için uyarlanmış kullanıcı yöneticisi testi.
Hedef Dosya: tests/test_user_management.py
--------------------------------------------------
"""
import sys
import os
...
target_test = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'tests', 'test_user_management.py'))
