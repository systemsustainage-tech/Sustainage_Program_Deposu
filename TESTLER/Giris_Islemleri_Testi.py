...
--------------------------------------------------
Açıklama: Kullanıcı giriş ekranı ve kimlik doğrulama işlemlerini test eder.
Orijinal Dosya: c:\SDG\tools\test_login.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\tools\test_login.py"
