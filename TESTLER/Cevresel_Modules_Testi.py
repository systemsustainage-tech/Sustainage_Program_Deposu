...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_environmental_modules.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\tools\test_environmental_modules.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\tools\test_environmental_modules.py"
