...
--------------------------------------------------
Açıklama: Bu test dosyası 'quick_gri_ui_test.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\tools\quick_gri_ui_test.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\tools\quick_gri_ui_test.py"
