...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_tcfd.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\tests\test_tcfd.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\tests\test_tcfd.py"
