...
--------------------------------------------------
Açıklama: Kullanıcı ekleme, silme ve yetkilendirme işlemlerini test eder.
Orijinal Dosya: c:\SDG\tools\test_user_management.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\tools\test_user_management.py"
