...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_user_manager_simple.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\\SDG\\tests\\unit\\test_user_manager_simple.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\tests\unit\test_user_manager_simple.py"
