...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_create_user_email.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\scripts\test_create_user_email.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\scripts\test_create_user_email.py"
