...
--------------------------------------------------
Açıklama: E-posta gönderme, şablonlar ve SMTP bağlantılarını test eder.
Orijinal Dosya: c:\SDG\scripts\tests\test_email_system.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\scripts\tests\test_email_system.py"
