...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_trend.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\scripts\tests\test_trend.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\scripts\tests\test_trend.py"
