...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_sdg_data_collection.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\deploy\ready_for_server\backend\modules\sdg\tests\test_sdg_data_collection.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\deploy\ready_for_server\backend\modules\sdg\tests\test_sdg_data_collection.py"
