...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_template_email.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\scripts\tests\test_template_email.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\scripts\tests\test_template_email.py"
