...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_gri_parser_real.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\scripts\tests\test_gri_parser_real.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\scripts\tests\test_gri_parser_real.py"
