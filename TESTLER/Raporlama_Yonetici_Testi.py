...
--------------------------------------------------
Açıklama: Web programı için uyarlanmış raporlama yöneticisi testi.
Hedef Dosya: tests/test_reporting.py
--------------------------------------------------
"""
import sys
import os
...
target_test = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'tests', 'test_reporting.py'))
