...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_cbam_manager.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\\SDG\\tests\\unit\\test_cbam_manager.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\tests\unit\test_cbam_manager.py"
