...
--------------------------------------------------
Açıklama: Bu test dosyası 'verify_and_test.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\verify_and_test.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\verify_and_test.py"
