...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_hosting_api.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\test_hosting_api.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\test_hosting_api.py"
