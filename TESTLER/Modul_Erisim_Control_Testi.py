...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_module_access_control.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\tools\test_module_access_control.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\tools\test_module_access_control.py"
