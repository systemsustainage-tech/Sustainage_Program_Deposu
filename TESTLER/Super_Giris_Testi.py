...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_super_login.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\tools\test_super_login.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\tools\test_super_login.py"
