...
--------------------------------------------------
Açıklama: Sürdürülebilir Kalkınma Amaçları modülünün entegrasyonunu test eder.
Orijinal Dosya: c:\SDG\tests\test_sdg_integration.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\tests\test_sdg_integration.py"
