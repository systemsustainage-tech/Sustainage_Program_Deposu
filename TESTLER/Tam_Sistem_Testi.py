...
--------------------------------------------------
Açıklama: Bu test dosyası 'full_system_test.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\full_system_test.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\full_system_test.py"
