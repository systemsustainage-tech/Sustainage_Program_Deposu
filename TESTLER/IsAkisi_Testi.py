...
--------------------------------------------------
Açıklama: Bu test dosyası 'test_workflow.py' dosyasını çalıştırır. Otomatik oluşturulmuştur.
Orijinal Dosya: c:\SDG\scripts\tests\test_workflow.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\scripts\tests\test_workflow.py"
