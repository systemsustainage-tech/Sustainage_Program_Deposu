...
--------------------------------------------------
Açıklama: Şifre sıfırlama akışını ve e-posta gönderimini test eder.
Orijinal Dosya: c:\SDG\tools\test_password_reset.py
--------------------------------------------------
"""
import sys
import os
...
original_file = r"c:\SDG\tools\test_password_reset.py"
